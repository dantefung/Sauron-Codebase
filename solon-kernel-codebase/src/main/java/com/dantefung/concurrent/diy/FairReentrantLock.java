...
/**
 * Fair reentrant lock is the extended version of {@link FairLock} and
 * supports the multiple request from the thread which holds the lock 
 * currently. The advantage of reentrant lock is you can use the same 
 * lock in different parts of the code without worrying a dead lock.
 * 
 * @author Kirana NS
 */
public class FairReentrantLock implements Lock {
	...
	private List<MonitorObject> lockRequestRegistry = new ArrayList<>();

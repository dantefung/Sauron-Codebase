...
public class JsonExtractUtil {
    ...
    public static Object extract(Map<String, Object> extra, String topField, String nestField) {
        if (extra == null || extra.isEmpty() || org.apache.commons.lang3.StringUtils.isBlank(topField)) {
            return null;
        }
        if (org.apache.commons.lang3.StringUtils.isBlank(nestField)) {
    ...
    public static Object extract(String json, String topField, String nestField, boolean isTopFieldString) {
        try {
            if (org.apache.commons.lang3.StringUtils.isBlank(json) || org.apache.commons.lang3.StringUtils.isBlank(topField)) {
                return null;
            }

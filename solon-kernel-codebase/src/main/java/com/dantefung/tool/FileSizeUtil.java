...
public class FileSizeUtil {
	...
	public static void main(String[] args) {
		System.out.println(byteFormat(1024, true));
		System.out.println(byteFormat(8*1024, true));
		System.out.println(byteFormat(8*1024*1024, true));
		System.out.println(formatFileSize(8*1024*1024));
	}
